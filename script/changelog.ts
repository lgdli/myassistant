...
Generates UPCOMING_CHANGELOG.md by running the myassistant changelog command.

Options:
  -f, --from <version>   Starting version (default: latest non-draft GitHub release)
  -t, --to <ref>         Ending ref (default: HEAD)
      --variant <name>   Thinking variant for myassistant run (default: low)
      --quiet            Suppress MyAssistant command output unless it fails
