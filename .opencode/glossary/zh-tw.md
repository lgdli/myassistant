...
- PR #13942: https://github.com/anomalyco/myassistant/pull/13942

## Do Not Translate (Locale Additions)

- `MyAssistant` (preserve casing in prose; keep `opencode` only when it is part of commands, package names, paths, or code)
- `MyAssistant Zen`
- `MyAssistant CLI`
- `CLI`, `TUI`, `MCP`, `OAuth`
...
- Avoid `opencode` in prose when referring to the product name; use `MyAssistant`
