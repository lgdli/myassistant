...
- PR #10809: https://github.com/anomalyco/myassistant/pull/10809
- PR #11496: https://github.com/anomalyco/myassistant/pull/11496

## Do Not Translate (Locale Additions)

- `MyAssistant` (preserve casing in prose; keep `opencode` only in commands, package names, paths, or code)
- `MyAssistant CLI`
- `CLI`, `TUI`, `MCP`, `OAuth`
