...
- PR #15835: https://github.com/anomalyco/myassistant/pull/15835

## Do Not Translate (Locale Additions)

- `MyAssistant` (preserve casing in prose, docs, and UI copy)
...
- Keep product naming consistent: `MyAssistant` in prose, `opencode` only for exact technical identifiers
...
- Avoid changing `opencode` to `MyAssistant` inside commands, URLs, package names, or code literals
