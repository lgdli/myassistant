...
const STORAGE_KEYS = {
  THEME_ID: "myassistant-theme-id",
  COLOR_SCHEME: "myassistant-color-scheme",
  THEME_CSS_LIGHT: "myassistant-theme-css-light",
  THEME_CSS_DARK: "myassistant-theme-css-dark",
} as const
