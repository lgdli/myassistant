...
import { base64Encode } from "@myassistant-ai/core/util/encode"
import { decode64 } from "@/utils/base64"
import { ResizeHandle } from "@myassistant-ai/ui/resize-handle"
import { Button } from "@myassistant-ai/ui/button"
import { IconButton } from "@myassistant-ai/ui/icon-button"
import { Tooltip } from "@myassistant-ai/ui/tooltip"
...
import { Session, type Message } from "@myassistant-ai/sdk/v2/client"
...
import { showToast, Toast, toaster } from "@myassistant-ai/ui/toast"
...
import { retry } from "@myassistant-ai/core/util/retry"
...
import { useTheme, type ColorScheme } from "@myassistant-ai/ui/theme/context"
...
export default function Layout(props: ParentProps) {
  ...
  const sidebarContent = (mobile?: boolean) => (
    <SidebarContent
      ...
      onOpenHelp={() => platform.openLink("https://myassistant.ai/desktop-feedback")}
      renderPanel={() =>
