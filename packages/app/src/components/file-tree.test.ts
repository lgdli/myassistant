...
beforeAll(async () => {
  ...
  mock.module("@myassistant-ai/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@myassistant-ai/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@myassistant-ai/ui/icon", () => ({ Icon: () => null }))
  mock.module("@myassistant-ai/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
