import { withAlpha } from "@myassistant-ai/ui/theme/color"
import { useTheme } from "@myassistant-ai/ui/theme/context"
import { resolveThemeVariant } from "@myassistant-ai/ui/theme/resolve"
import type { HexColor } from "@myassistant-ai/ui/theme/types"
...
export const Terminal = (props: TerminalProps) => {
  ...
  const username = auth?.username ?? "myassistant"
      ...
      const connectToken = async () => {
        const result = await client.pty
          .connectToken(
            ...
            {
              throwOnError: false,
              headers: { "x-myassistant-ticket": "1" },
            },
          )
          .catch((err: unknown) => {
