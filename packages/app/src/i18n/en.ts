export const dict = {
  ...
  "dialog.provider.myassistant.note": "Curated models including Claude, GPT, Gemini and more",
  "dialog.provider.myassistant.tagline": "Reliable optimized models",
  "dialog.provider.myassistantGo.tagline": "Low cost subscription for everyone",
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by MyAssistant",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in MyAssistant.",
  "provider.connect.apiKey.label": "{{provider}} API key",
  "provider.connect.apiKey.placeholder": "API key",
  "provider.connect.apiKey.required": "API key is required",
  "provider.connect.myassistantZen.line1":
    "MyAssistant Zen gives you access to a curated set of reliable optimized models for coding agents.",
  "provider.connect.myassistantZen.line2":
    "With a single API key you'll get access to models such as Claude, GPT, Gemini, GLM and more.",
  "provider.connect.myassistantZen.visit.prefix": "Visit ",
  "provider.connect.myassistantZen.visit.link": "myassistant.ai/zen",
  "provider.connect.myassistantZen.visit.suffix": " to collect your API key.",
  "provider.connect.oauth.code.visit.prefix": "Visit ",
  "provider.connect.oauth.code.visit.link": "this link",
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in MyAssistant.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in MyAssistant.",
  ...
  "dialog.plugins.empty": "Plugins configured in myassistant.json",
  ...
  "dialog.server.description": "Switch which MyAssistant server this app connects to.",
  ...
  "toast.update.description": "A new version of MyAssistant ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the MyAssistant team",
  ...
  "error.chain.checkConfig": "Check your config (myassistant.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, MyAssistant does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "MyAssistant includes free models so you can start immediately.",
  ...
  "settings.desktop.wsl.description": "Run the MyAssistant server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for MyAssistant",
  ...
  "settings.general.row.appearance.description": "Customise how MyAssistant looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether MyAssistant follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how MyAssistant is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when MyAssistant launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of MyAssistant.",
