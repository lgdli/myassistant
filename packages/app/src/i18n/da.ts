export const dict = {
  ...
  "dialog.provider.myassistant.note": "Udvalgte modeller inklusive Claude, GPT, Gemini og flere",
  "dialog.provider.myassistant.tagline": "Pålidelige optimerede modeller",
  "dialog.provider.myassistantGo.tagline": "Billigt abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller leveret af MyAssistant",
  ...
  "provider.connect.apiKey.description":
    "Indtast din {{provider}} API-nøgle for at forbinde din konto og bruge {{provider}} modeller i MyAssistant.",
  ...
  "provider.connect.myassistantZen.line1":
    "MyAssistant Zen giver dig adgang til et udvalg af pålidelige optimerede modeller til kodningsagenter.",
  ...
  "provider.connect.myassistantZen.visit.prefix": "Besøg ",
  "provider.connect.myassistantZen.visit.link": "myassistant.ai/zen",
  "provider.connect.myassistantZen.visit.suffix": " for at hente din API-nøgle.",
  "provider.connect.oauth.code.visit.prefix": "Besøg ",
  "provider.connect.oauth.code.visit.link": "dette link",
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode for at forbinde din konto og bruge {{provider}} modeller i MyAssistant.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge {{provider}} modeller i MyAssistant.",
  ...
  "dialog.plugins.empty": "Plugins konfigureret i myassistant.json",
  ...
  "dialog.server.description": "Skift hvilken MyAssistant-server denne app forbinder til.",
  ...
  "toast.update.description": "En ny version af MyAssistant ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til MyAssistant-teamet",
  ...
  "error.chain.checkConfig": "Tjek dine konfigurations (myassistant.json) udbyder/modelnavne",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. Bemærk, MyAssistant understøtter ikke MCP-godkendelse endnu.',
  ...
  "sidebar.gettingStarted.line1": "MyAssistant inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "settings.desktop.wsl.description": "Kør MyAssistant-serveren inde i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for MyAssistant",
  "settings.general.row.appearance.title": "Udseende",
  "settings.general.row.appearance.description": "Tilpas hvordan MyAssistant ser ud på din enhed",
  "settings.general.row.colorScheme.title": "Farveskema",
  "settings.general.row.colorScheme.description": "Vælg om MyAssistant følger systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas hvordan MyAssistant er temabestemt.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når MyAssistant starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af MyAssistant.",
