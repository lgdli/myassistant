export const dict = {
  ...
  "dialog.provider.myassistant.note": "Wyselekcjonowane modele, w tym Claude, GPT, Gemini i inne",
  "dialog.provider.myassistant.tagline": "Niezawodne, zoptymalizowane modele",
  "dialog.provider.myassistantGo.tagline": "Tania subskrypcja dla każdego",
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez MyAssistant",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w MyAssistant.",
  ...
  "provider.connect.myassistantZen.line1":
    "MyAssistant Zen daje dostęp do wybranego zestawu niezawodnych, zoptymalizowanych modeli dla agentów kodujących.",
  ...
  "provider.connect.myassistantZen.visit.prefix": "Odwiedź ",
  "provider.connect.myassistantZen.visit.link": "myassistant.ai/zen",
  "provider.connect.myassistantZen.visit.suffix": ", aby odebrać swój klucz API.",
  "provider.connect.oauth.code.visit.prefix": "Odwiedź ",
  "provider.connect.oauth.code.visit.link": "ten link",
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w MyAssistant.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w MyAssistant.",
  ...
  "dialog.plugins.empty": "Wtyczki skonfigurowane w myassistant.json",
  ...
  "dialog.server.description": "Przełącz serwer MyAssistant, z którym łączy się ta aplikacja.",
  ...
  "toast.update.description": "Nowa wersja MyAssistant ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu MyAssistant",
  ...
  "error.chain.checkConfig": "Sprawdź swoją konfigurację (myassistant.json) nazwy dostawców/modeli",
  ...
  "sidebar.gettingStarted.line1": "MyAssistant zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla MyAssistant",
  "settings.general.row.appearance.title": "Wygląd",
  "settings.general.row.appearance.description": "Dostosuj wygląd MyAssistant na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy MyAssistant ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw MyAssistant.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania MyAssistant",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji MyAssistant.",
