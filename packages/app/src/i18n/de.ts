...
export const dict = {
  ...
  "dialog.provider.myassistant.note": "Kuratierte Modelle inklusive Claude, GPT, Gemini und mehr",
  "dialog.provider.myassistant.tagline": "Zuverlässige, optimierte Modelle",
  "dialog.provider.myassistantGo.tagline": "Kostengünstiges Abo für alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Kostenlose Modelle von MyAssistant",
  ...
  "provider.connect.apiKey.description":
    "Geben Sie Ihren {{provider}} API-Schlüssel ein, um Ihr Konto zu verbinden und {{provider}} Modelle in MyAssistant zu nutzen.",
  ...
  "provider.connect.myassistantZen.line1":
    "MyAssistant Zen bietet Ihnen Zugriff auf eine kuratierte Auswahl zuverlässiger, optimierter Modelle für Coding-Agenten.",
  ...
  "provider.connect.myassistantZen.visit.prefix": "Besuchen Sie ",
  "provider.connect.myassistantZen.visit.link": "myassistant.ai/zen",
  "provider.connect.myassistantZen.visit.suffix": ", um Ihren API-Schlüssel zu erhalten.",
  "provider.connect.oauth.code.visit.prefix": "Besuchen Sie ",
  "provider.connect.oauth.code.visit.link": "diesen Link",
  "provider.connect.oauth.code.visit.suffix":
    ", um Ihren Autorisierungscode zu erhalten, Ihr Konto zu verbinden und {{provider}} Modelle in MyAssistant zu nutzen.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " und geben Sie den untenstehenden Code ein, um Ihr Konto zu verbinden und {{provider}} Modelle in MyAssistant zu nutzen.",
  ...
  "dialog.plugins.empty": "In myassistant.json konfigurierte Plugins",
  ...
  "dialog.server.description": "Wechseln Sie den MyAssistant-Server, mit dem sich diese App verbindet.",
  ...
  "toast.update.description": "Eine neue Version von MyAssistant ({{version}}) ist zur Installation verfügbar.",
  ...
  "error.page.report.prefix": "Bitte melden Sie diesen Fehler dem MyAssistant-Team",
  ...
  "error.chain.checkConfig": "Überprüfen Sie Ihre Konfiguration (myassistant.json) auf Anbieter-/Modellnamen",
  "error.chain.mcpFailed":
    'MCP-Server "{{name}}" fehlgeschlagen. Hinweis: MyAssistant unterstützt noch keine MCP-Authentifizierung.',
  ...
  "sidebar.gettingStarted.line1": "MyAssistant enthält kostenlose Modelle, damit Sie sofort loslegen können.",
  ...
  "settings.desktop.wsl.description": "MyAssistant-Server innerhalb von WSL unter Windows ausführen.",
  ...
  "settings.general.row.language.description": "Die Anzeigesprache für MyAssistant ändern",
  "settings.general.row.appearance.title": "Erscheinungsbild",
  "settings.general.row.appearance.description": "Anpassen, wie MyAssistant auf Ihrem Gerät aussieht",
  "settings.general.row.colorScheme.title": "Farbschema",
  "settings.general.row.colorScheme.description":
    "Wählen Sie, ob MyAssistant dem System-, hellen oder dunklen Thema folgt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Das Thema von MyAssistant anpassen.",
  ...
  "settings.updates.row.startup.description": "Beim Start von MyAssistant automatisch nach Updates suchen",
  ...
  "settings.updates.toast.latest.description": "Du verwendest die aktuelle Version von MyAssistant.",
