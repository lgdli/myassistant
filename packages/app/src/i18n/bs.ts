export const dict = {
  ...
  "dialog.provider.myassistant.note": "Kurirani modeli uključujući Claude, GPT, Gemini i druge",
  "dialog.provider.myassistant.tagline": "Pouzdani optimizovani modeli",
  "dialog.provider.myassistantGo.tagline": "Povoljna pretplata za sve",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje MyAssistant",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u MyAssistant-u.",
  ...
  "provider.connect.myassistantZen.line1":
    "MyAssistant Zen ti daje pristup kuriranom skupu pouzdanih, optimizovanih modela za coding agente.",
  ...
  "provider.connect.myassistantZen.visit.prefix": "Posjeti ",
  "provider.connect.myassistantZen.visit.link": "myassistant.ai/zen",
  "provider.connect.myassistantZen.visit.suffix": " da preuzmeš svoj API ključ.",
  "provider.connect.oauth.code.visit.prefix": "Posjeti ",
  "provider.connect.oauth.code.visit.link": "ovaj link",
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u MyAssistant-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u MyAssistant-u.",
  ...
  "dialog.plugins.empty": "Plugini su konfigurisani u myassistant.json",
  ...
  "dialog.server.description": "Promijeni na koji se MyAssistant server ova aplikacija povezuje.",
  ...
  "toast.update.description": "Nova verzija MyAssistant-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku MyAssistant timu",
  ...
  "error.chain.checkConfig": "Provjeri konfiguraciju (myassistant.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: MyAssistant još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "MyAssistant uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni MyAssistant server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u MyAssistant-u",
  "settings.general.row.appearance.title": "Izgled",
  "settings.general.row.appearance.description": "Prilagodi kako MyAssistant izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li MyAssistant prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu MyAssistant-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se MyAssistant pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju MyAssistant-a.",
