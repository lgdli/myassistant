export const dict = {
  ...
  "dialog.provider.myassistant.note": "Modèles sélectionnés incluant Claude, GPT, Gemini et plus",
  "dialog.provider.myassistant.tagline": "Modèles optimisés et fiables",
  "dialog.provider.myassistantGo.tagline": "Abonnement abordable pour tous",
  ...
  "dialog.model.unpaid.freeModels.title": "Modèles gratuits fournis par MyAssistant",
  ...
  "provider.connect.apiKey.description":
    "Entrez votre clé API {{provider}} pour connecter votre compte et utiliser les modèles {{provider}} dans MyAssistant.",
  ...
  "provider.connect.myassistantZen.line1":
    "MyAssistant Zen vous donne accès à un ensemble sélectionné de modèles fiables et optimisés pour les agents de codage.",
  "provider.connect.myassistantZen.line2":
    "Avec une seule clé API, vous aurez accès à des modèles tels que Claude, GPT, Gemini, GLM et plus encore.",
  "provider.connect.myassistantZen.visit.prefix": "Visitez ",
  "provider.connect.myassistantZen.visit.link": "myassistant.ai/zen",
  "provider.connect.myassistantZen.visit.suffix": " pour récupérer votre clé API.",
  "provider.connect.oauth.code.visit.prefix": "Visitez ",
  "provider.connect.oauth.code.visit.link": "ce lien",
  "provider.connect.oauth.code.visit.suffix":
    " pour récupérer votre code d'autorisation afin de connecter votre compte et utiliser les modèles {{provider}} dans MyAssistant.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " et entrez le code ci-dessous pour connecter votre compte et utiliser les modèles {{provider}} dans MyAssistant.",
  ...
  "dialog.plugins.empty": "Plugins configurés dans myassistant.json",
  ...
  "dialog.server.description": "Changez le serveur MyAssistant auquel cette application se connecte.",
  ...
  "toast.update.description":
    "Une nouvelle version d'MyAssistant ({{version}}) est maintenant disponible pour installation.",
  ...
  "error.page.report.prefix": "Veuillez signaler cette erreur à l'équipe MyAssistant",
  ...
  "error.chain.checkConfig": "Vérifiez votre configuration (myassistant.json) pour les noms de fournisseur/modèle",
  "error.chain.mcpFailed":
    "Le serveur MCP \"{{name}}\" a échoué. Notez qu'MyAssistant ne supporte pas encore l'authentification MCP.",
  ...
  "sidebar.gettingStarted.line1":
    "MyAssistant inclut des modèles gratuits pour que vous puissiez commencer immédiatement.",
  ...
  "app.name.desktop": "MyAssistant Desktop",
  ...
  "settings.desktop.wsl.description": "Exécuter le serveur MyAssistant dans WSL sur Windows.",
  ...
  "settings.general.row.language.description": "Changer la langue d'affichage pour MyAssistant",
  "settings.general.row.appearance.title": "Apparence",
  "settings.general.row.appearance.description": "Personnaliser l'apparence d'MyAssistant sur votre appareil",
  "settings.general.row.colorScheme.title": "Schéma de couleurs",
  "settings.general.row.colorScheme.description": "Choisissez si MyAssistant suit le thème système, clair ou sombre",
  "settings.general.row.theme.title": "Thème",
  "settings.general.row.theme.description": "Personnaliser le thème d'MyAssistant.",
  ...
  "settings.updates.row.startup.description": "Vérifier automatiquement les mises à jour au lancement d'MyAssistant",
  ...
  "settings.updates.toast.latest.description": "Vous utilisez la dernière version d'MyAssistant.",
