...
export const dict = {
  ...
  "dialog.provider.myassistant.note": "Claude, GPT, Gemini ve daha fazlasını içeren seçilmiş modeller",
  "dialog.provider.myassistant.tagline": "Güvenilir optimize edilmiş modeller",
  "dialog.provider.myassistantGo.tagline": "Herkes için düşük maliyetli abonelik",
  ...
  "dialog.model.unpaid.freeModels.title": "MyAssistant tarafından sunulan ücretsiz modeller",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve MyAssistant'da {{provider}} modellerini kullanmak için {{provider}} API anahtarınızı girin.",
  ...
  "provider.connect.myassistantZen.line1":
    "MyAssistant Zen, kodlama ajanları için seçilmiş güvenilir optimize edilmiş modellere erişim sağlar.",
  ...
  "provider.connect.myassistantZen.visit.prefix": "",
  "provider.connect.myassistantZen.visit.link": "myassistant.ai/zen",
  "provider.connect.myassistantZen.visit.suffix": " adresini ziyaret ederek API anahtarınızı alın.",
  "provider.connect.oauth.code.visit.prefix":
    "Hesabınızı bağlamak ve MyAssistant'da {{provider}} modellerini kullanmak için ",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak MyAssistant'da {{provider}} modellerini kullanın.",
  ...
  "dialog.plugins.empty": "Eklentiler myassistant.json içinde yapılandırılır",
  ...
  "dialog.server.description": "Bu uygulamanın hangi MyAssistant sunucusuna bağlanacağını değiştirin.",
  ...
  "toast.update.description": "MyAssistant'un yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı MyAssistant ekibine bildirin",
  ...
  "error.chain.checkConfig": "Yapılandırma dosyanızı (myassistant.json) sağlayıcı/model adlarını kontrol edin",
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" başarısız oldu. Not: MyAssistant henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "sidebar.gettingStarted.line1": "MyAssistant ücretsiz modeller içerir, böylece hemen başlayabilirsiniz.",
  ...
  "app.name.desktop": "MyAssistant Masaüstü",
  ...
  "settings.desktop.wsl.description": "MyAssistant sunucusunu Windows'ta WSL içinde çalıştırın.",
  ...
  "settings.general.row.language.description": "MyAssistant'un görünüm dilini değiştirin",
  "settings.general.row.appearance.title": "Görünüm",
  "settings.general.row.appearance.description": "MyAssistant'un cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.colorScheme.title": "Renk şeması",
  "settings.general.row.colorScheme.description":
    "MyAssistant'un sistem, açık veya koyu temayı takip etip etmeyeceğini seçin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "MyAssistant'un temasını özelleştirin.",
  ...
  "settings.updates.row.startup.description": "MyAssistant başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "MyAssistant'un en son sürümünü kullanıyorsunuz.",
