export const dict = {
  ...
  "dialog.provider.myassistant.note": "Modelos seleccionados incluyendo Claude, GPT, Gemini y más",
  "dialog.provider.myassistant.tagline": "Modelos optimizados y fiables",
  "dialog.provider.myassistantGo.tagline": "Suscripción económica para todos",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos proporcionados por MyAssistant",
  ...
  "provider.connect.apiKey.description":
    "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en MyAssistant.",
  ...
  "provider.connect.myassistantZen.line1":
    "MyAssistant Zen te da acceso a un conjunto curado de modelos fiables optimizados para agentes de programación.",
  "provider.connect.myassistantZen.line2":
    "Con una sola clave API obtendrás acceso a modelos como Claude, GPT, Gemini, GLM y más.",
  "provider.connect.myassistantZen.visit.prefix": "Visita ",
  "provider.connect.myassistantZen.visit.link": "myassistant.ai/zen",
  "provider.connect.myassistantZen.visit.suffix": " para obtener tu clave API.",
  "provider.connect.oauth.code.visit.prefix": "Visita ",
  "provider.connect.oauth.code.visit.link": "este enlace",
  "provider.connect.oauth.code.visit.suffix":
    " para obtener tu código de autorización para conectar tu cuenta y usar modelos de {{provider}} en MyAssistant.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e introduce el código a continuación para conectar tu cuenta y usar modelos de {{provider}} en MyAssistant.",
  ...
  "dialog.plugins.empty": "Plugins configurados en myassistant.json",
  ...
  "dialog.server.description": "Cambiar a qué servidor de MyAssistant se conecta esta app.",
  ...
  "toast.update.description": "Una nueva versión de MyAssistant ({{version}}) está disponible para instalar.",
  ...
  "error.page.report.prefix": "Por favor reporta este error al equipo de MyAssistant",
  ...
  "error.chain.checkConfig": "Comprueba los nombres de proveedor/modelo en tu configuración (myassistant.json)",
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" falló. Nota, MyAssistant no soporta autenticación MCP todavía.',
  ...
  "sidebar.gettingStarted.line1": "MyAssistant incluye modelos gratuitos para que puedas empezar inmediatamente.",
  ...
  "settings.desktop.wsl.description": "Ejecutar el servidor MyAssistant dentro de WSL en Windows.",
  ...
  "settings.general.row.language.description": "Cambiar el idioma de visualización para MyAssistant",
  "settings.general.row.appearance.title": "Apariencia",
  "settings.general.row.appearance.description": "Personaliza cómo se ve MyAssistant en tu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de color",
  "settings.general.row.colorScheme.description": "Elige si MyAssistant sigue el tema del sistema, claro u oscuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personaliza el tema de MyAssistant.",
  ...
  "settings.updates.row.startup.description": "Buscar actualizaciones automáticamente cuando se inicia MyAssistant",
  ...
  "settings.updates.toast.latest.description": "Estás usando la última versión de MyAssistant.",
