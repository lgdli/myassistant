...
export const dict = {
  ...
  "dialog.provider.myassistant.note": "Utvalgte modeller inkludert Claude, GPT, Gemini og mer",
  "dialog.provider.myassistant.tagline": "Pålitelige, optimaliserte modeller",
  "dialog.provider.myassistantGo.tagline": "Rimelig abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av MyAssistant",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn din {{provider}} API-nøkkel for å koble til kontoen din og bruke {{provider}}-modeller i MyAssistant.",
  ...
  "provider.connect.myassistantZen.line1":
    "MyAssistant Zen gir deg tilgang til et utvalg av pålitelige optimaliserte modeller for kodeagenter.",
  ...
  "provider.connect.myassistantZen.visit.prefix": "Besøk ",
  "provider.connect.myassistantZen.visit.link": "myassistant.ai/zen",
  "provider.connect.myassistantZen.visit.suffix": " for å hente API-nøkkelen din.",
  "provider.connect.oauth.code.visit.prefix": "Besøk ",
  "provider.connect.oauth.code.visit.link": "denne lenken",
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i MyAssistant.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i MyAssistant.",
  ...
  "dialog.plugins.empty": "Plugins konfigurert i myassistant.json",
  ...
  "dialog.server.description": "Bytt hvilken MyAssistant-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av MyAssistant ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til MyAssistant-teamet",
  ...
  "error.chain.checkConfig": "Sjekk leverandør-/modellnavnene i konfigurasjonen din (myassistant.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at MyAssistant ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "MyAssistant inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "Kjør MyAssistant-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for MyAssistant",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan MyAssistant ser ut på enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description": "Velg om MyAssistant skal følge systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass hvordan MyAssistant er tematisert.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når MyAssistant starter",
  ...
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av MyAssistant.",
