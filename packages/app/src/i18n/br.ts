export const dict = {
  ...
  "dialog.provider.myassistant.note": "Modelos selecionados incluindo Claude, GPT, Gemini e mais",
  "dialog.provider.myassistant.tagline": "Modelos otimizados e confiáveis",
  "dialog.provider.myassistantGo.tagline": "Assinatura de baixo custo para todos",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos fornecidos pelo MyAssistant",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no MyAssistant.",
  ...
  "provider.connect.myassistantZen.line1":
    "MyAssistant Zen oferece acesso a um conjunto selecionado de modelos confiáveis otimizados para agentes de código.",
  ...
  "provider.connect.myassistantZen.visit.prefix": "Visite ",
  "provider.connect.myassistantZen.visit.link": "myassistant.ai/zen",
  "provider.connect.myassistantZen.visit.suffix": " para obter sua chave de API.",
  "provider.connect.oauth.code.visit.prefix": "Visite ",
  "provider.connect.oauth.code.visit.link": "este link",
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no MyAssistant.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no MyAssistant.",
  ...
  "dialog.plugins.empty": "Plugins configurados em myassistant.json",
  ...
  "dialog.server.description": "Trocar para qual servidor MyAssistant este aplicativo se conecta.",
  ...
  "toast.update.description": "Uma nova versão do MyAssistant ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do MyAssistant",
  ...
  "error.chain.checkConfig": "Verifique os nomes de provedor/modelo na sua configuração (myassistant.json)",
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: MyAssistant ainda não suporta autenticação MCP.',
  ...
  "sidebar.gettingStarted.line1": "MyAssistant inclui modelos gratuitos para você começar imediatamente.",
  ...
  "settings.desktop.wsl.description": "Executar o servidor MyAssistant dentro do WSL no Windows.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do MyAssistant",
  "settings.general.row.appearance.title": "Aparência",
  "settings.general.row.appearance.description": "Personalize como o MyAssistant aparece no seu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de cores",
  "settings.general.row.colorScheme.description": "Escolha se o MyAssistant segue o tema do sistema, claro ou escuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o MyAssistant é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o MyAssistant iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do MyAssistant.",
