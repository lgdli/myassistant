import { Message, Model, Part, Session, SessionStatus, SnapshotFileDiff, UserMessage } from "@myassistant-ai/sdk/v2"
import { SessionTurn } from "@myassistant-ai/ui/session-turn"
import { SessionReview } from "@myassistant-ai/ui/session-review"
import { DataProvider } from "@myassistant-ai/ui/context"
import { FileComponentProvider } from "@myassistant-ai/ui/context/file"
import { WorkerPoolProvider } from "@myassistant-ai/ui/context/worker-pool"
import { createAsync, query, useParams } from "@solidjs/router"
import { createMemo, createSignal, ErrorBoundary, For, Match, Show, Switch } from "solid-js"
import { Share } from "~/core/share"
import { Logo, Mark } from "@myassistant-ai/ui/logo"
import { IconButton } from "@myassistant-ai/ui/icon-button"
import { ProviderIcon } from "@myassistant-ai/ui/provider-icon"
import { iife } from "@myassistant-ai/core/util/iife"
import { Binary } from "@myassistant-ai/core/util/binary"
import { NamedError } from "@myassistant-ai/core/util/error"
import { DateTime } from "luxon"
import { createStore } from "solid-js/store"
import z from "zod"
import NotFound from "../[...404]"
import { Tabs } from "@myassistant-ai/ui/tabs"
import { MessageNav } from "@myassistant-ai/ui/message-nav"
import { FileSSR } from "@myassistant-ai/ui/file-ssr"
...
const ClientOnlyWorkerPoolProvider = clientOnly(() =>
  import("@myassistant-ai/ui/pierre/worker").then((m) => ({
      ...
      <Show when={data()}>
        {(data) => {
          ...
          const ogImage = createMemo(() => {
            ...
            return `https://social-cards.sst.dev/myassistant-share/${encodedTitle}.png?model=${modelParam}&version=${version}&id=${data().shareID}`
          })

          return (
            <>
              <Show when={info().title}>
                <Title>{info().title} | MyAssistant</Title>
              </Show>
              <Meta name="description" content="myassistant - The AI coding agent built for the terminal." />
                        ...
                        <div class="relative bg-background-stronger w-screen h-screen overflow-hidden flex flex-col">
                          <header class="h-12 px-6 py-2 flex items-center justify-between self-stretch bg-background-base border-b border-border-weak-base">
                            ...
                            <div class="flex gap-3 items-center">
                              <IconButton
                                as={"a"}
                                href="https://github.com/anomalyco/myassistant"
                                target="_blank"
                                icon="github"
                                variant="ghost"
                              />
                              <IconButton
                                as={"a"}
                                href="https://myassistant.ai/discord"
                                target="_blank"
                                icon="discord"
                                variant="ghost"
                              />
