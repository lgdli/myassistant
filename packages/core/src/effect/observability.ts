...
import { ensureProcessMetadata } from "../util/myassistant-process"
...
export function resource(): { serviceName: string; serviceVersion: string; attributes: Record<string, string> } {
  ...
  return {
    serviceName: "myassistant",
    serviceVersion: InstallationVersion,
    attributes: {
      ...attributes,
      "deployment.environment.name": InstallationChannel,
      "myassistant.client": Flag.MYASSISTANT_CLIENT,
      "myassistant.process_role": processMetadata.processRole,
      "myassistant.run_id": processMetadata.runID,
