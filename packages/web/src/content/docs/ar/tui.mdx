---
title: TUI
description: استخدام واجهة المستخدم TUI في MyAssistant.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

يوفّر MyAssistant واجهة terminal تفاعلية (TUI) للعمل على مشاريعك باستخدام LLM.

يؤدي تشغيل MyAssistant إلى بدء واجهة TUI للدليل الحالي.
...
عند استخدام واجهة MyAssistant في terminal، يمكنك كتابة `/` متبوعة باسم أمر لتنفيذ الإجراءات بسرعة. مثلا:
...
أضف موفّرا إلى MyAssistant. يتيح لك اختيار أحد الموفّرين المتاحين وإضافة مفاتيح API الخاصة بهم.
...
اخرج من MyAssistant. _الأسماء المستعارة_: `/quit`, `/q`
...
يمكنك تخصيص سلوك واجهة TUI عبر ملف إعدادات MyAssistant.
