...
يستخدم [معرّف النموذج](/docs/config/#models) في إعدادات MyAssistant الصيغة `opencode/<model-id>`. على سبيل المثال، بالنسبة إلى GPT 5.5، ستستخدم `opencode/gpt-5.5` في إعداداتك.
