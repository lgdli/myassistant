---
title: خوادم LSP
description: يتكامل MyAssistant مع خوادم LSP لديك.
---

يتكامل MyAssistant مع بروتوكول خادم اللغة (LSP) لمساعدة LLM على التفاعل مع قاعدة الشيفرة لديك. ويستخدم التشخيصات لتزويد LLM بتغذية راجعة.

---

## المدمجة

يأتي MyAssistant مع عدة خوادم LSP مدمجة للغات الشائعة:
...
عندما يفتح myassistant ملفا، فإنه:
...
يمكنك تخصيص خوادم LSP عبر قسم `lsp` في إعدادات myassistant.
