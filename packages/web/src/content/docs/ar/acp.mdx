---
title: دعم ACP
description: استخدم MyAssistant في أي محرر متوافق مع ACP.
---

يدعم MyAssistant بروتوكول [Agent Client Protocol](https://agentclientprotocol.com) أو (ACP)، مما يتيح لك استخدامه مباشرة في المحررات وبيئات التطوير المتكاملة (IDEs) المتوافقة.
...
لاستخدام MyAssistant عبر ACP، اضبط محررك ليشغّل الأمر `myassistant acp`.

يشغّل هذا الأمر MyAssistant كعملية فرعية متوافقة مع ACP تتواصل مع محررك عبر JSON-RPC باستخدام stdio.
...
لفتحه، اختر الوكيل الجديد 'MyAssistant' من محدد الوكلاء في AI Chat.
...
لاستخدام MyAssistant كوكيل ACP في [CodeCompanion.nvim](https://github.com/olimorris/codecompanion.nvim)، أضف التالي إلى إعدادات Neovim:
...
يضبط هذا الإعداد CodeCompanion لاستخدام MyAssistant كوكيل ACP للدردشة.
...
يعمل MyAssistant عبر ACP بالطريقة نفسها التي يعمل بها في terminal. جميع الميزات مدعومة:
...
- خوادم MCP المضبوطة في إعدادات MyAssistant
