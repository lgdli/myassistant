...
يوجد نوعان من الوكلاء في MyAssistant: وكلاء أساسيون ووكلاء فرعيون.
...
يأتي MyAssistant مع وكيلين أساسيين مدمجين: **Build** و **Plan**. سنلقي نظرة عليهما أدناه.
...
يأتي MyAssistant مع وكيلين فرعيين مدمجين: **General** و **Explore**. سنلقي نظرة على ذلك أدناه.

---

## المدمجة

يأتي MyAssistant مع وكيلين أساسيين مدمجين ووكيلين فرعيين مدمجين.
...
هيّئ الوكلاء في ملف إعدادات `myassistant.json`:
...
- عام: `~/.config/myassistant/agents/`
- لكل مشروع: `.myassistant/agents/`
...
إذا لم يتم تحديد temperature، يستخدم MyAssistant القيم الافتراضية الخاصة بالنموذج؛ عادة 0 لمعظم النماذج و 0.55 لنماذج Qwen.
...
هذا المسار نسبي لمكان وجود ملف الإعدادات. لذلك يعمل هذا لكل من إعدادات MyAssistant العامة وإعدادات المشروع.
...
يستخدم معرّف النموذج في إعدادات MyAssistant الصيغة `provider/model-id`. على سبيل المثال، إذا كنت تستخدم [MyAssistant Zen](/docs/zen)، فستستخدم `myassistant/gpt-5.1-codex` لـ GPT 5.1 Codex.
...
:::tip
شغّل `myassistant models` لعرض قائمة بالنماذج المتاحة.
:::
...
:::tip
هل لديك وكيل تود مشاركته؟ [قدّم PR](https://github.com/anomalyco/myassistant).
:::
