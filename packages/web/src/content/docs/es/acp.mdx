---
title: Soporte ACP
description: Utilice MyAssistant en cualquier editor compatible con ACP.
---

MyAssistant admite el [Agent Client Protocol](https://agentclientprotocol.com) o (ACP), lo que le permite usarlo directamente en editores e IDE compatibles.
...
Para usar MyAssistant a través de ACP, configure su editor para ejecutar el comando `myassistant acp`.

El comando inicia MyAssistant como un subproceso compatible con ACP que se comunica con su editor a través de JSON-RPC a través de stdio.
...
Para abrirlo, use el nuevo agente 'MyAssistant' en el selector de agentes de AI Chat.
...
Para usar MyAssistant como agente ACP en [CodeCompanion.nvim](https://github.com/olimorris/codecompanion.nvim), agregue lo siguiente a su configuración de Neovim:
...
Esta configuración configura CodeCompanion para usar MyAssistant como agente ACP para el chat.
...
MyAssistant funciona igual a través de ACP que en la terminal. Todas las funciones son compatibles:
...
- Servidores MCP configurados en su configuración MyAssistant
