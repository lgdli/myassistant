...
Crear `.myassistant/commands/test.md`:
...
Puede agregar comandos personalizados a través de la configuración MyAssistant o creando archivos de Markdown en el directorio `commands/`.

---

### JSON

Utilice la opción `command` en su MyAssistant [config](/docs/config):
...
- Por proyecto: `.myassistant/commands/`
...
myassistant incluye varios comandos integrados como `/init`, `/undo`, `/redo`, `/share`, `/help`; [más información](/docs/tui#commands).
