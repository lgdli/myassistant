---
title: Compartir
description: Comparte tus conversaciones MyAssistant.
---

La función para compartir de MyAssistant te permite crear enlaces públicos a tus conversaciones de MyAssistant, para que puedas colaborar con compañeros de equipo u obtener ayuda de otros.
...
Cuando compartes una conversación, MyAssistant:
...
MyAssistant admite tres modos de compartir que controlan cómo se comparten las conversaciones:

---

### Manual (predeterminado)

De forma predeterminada, MyAssistant usa el modo de compartir manual. Las sesiones no se comparten automáticamente, pero puedes compartirlas manualmente usando el comando `/share`:
...
Para aplicar esto en todo su equipo para un proyecto determinado, agréguelo al `myassistant.json` en su proyecto y regístrelo en Git.
...
[Obtenga más información](/docs/enterprise) sobre el uso de myassistant en su organización.
