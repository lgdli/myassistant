---
title: TUI
description: Usando la interfaz de usuario del terminal MyAssistant.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

MyAssistant proporciona una interfaz de terminal interactiva o TUI para trabajar en sus proyectos con un LLM.

Al ejecutar MyAssistant se inicia TUI para el directorio actual.
...
Cuando utilice MyAssistant TUI, puede escribir `/` seguido de un nombre de comando para ejecutar acciones rápidamente. Por ejemplo:
...
Agregue un proveedor a MyAssistant. Le permite seleccionar entre proveedores disponibles y agregar sus claves API.
...
Salga de MyAssistant. _Alias_: `/quit`, `/q`
...
Esto es independiente de `myassistant.json`, que configura el comportamiento del servidor/tiempo de ejecución.
