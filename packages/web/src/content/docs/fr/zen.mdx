...
Le [model id](/docs/config/#models) dans votre configuration MyAssistant utilise le format `opencode/<model-id>`. Par exemple, pour GPT 5.5, vous utiliseriez `opencode/gpt-5.5` dans votre configuration.
