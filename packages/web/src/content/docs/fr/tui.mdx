---
title: TUI
description: Utilisation de l’interface utilisateur du terminal MyAssistant.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

MyAssistant fournit une interface de terminal interactif ou TUI pour travailler sur vos projets avec un LLM.

L’exécution de MyAssistant démarre le TUI pour le répertoire actuel.
...
Lorsque vous utilisez le MyAssistant TUI, vous pouvez taper `/` suivi d'un nom de commande pour exécuter rapidement des actions. Par exemple:
...
Ajoutez un fournisseur à MyAssistant. Vous permet de sélectionner parmi les fournisseurs disponibles et d’ajouter leurs clés API.
...
Quittez MyAssistant. *Alias* : `/quit`, `/q`
...
Ceci est séparé de `myassistant.json`, qui configure le comportement du serveur/d'exécution.
