---
title: TUI
description: Usando a interface de usuário de terminal myassistant.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

O myassistant fornece uma interface de terminal interativa ou TUI para trabalhar em seus projetos com um LLM.

Executar myassistant inicia o TUI para o diretório atual.
...
Ao usar o TUI do myassistant, você pode digitar `/` seguido pelo nome de um comando para executar ações rapidamente. Por exemplo:
...
Adicione um provedor ao myassistant. Permite que você selecione entre os provedores disponíveis e adicione suas chaves de API.
...
Saia do myassistant. _Aliases_: `/quit`, `/q`
...
Isso é separado do `myassistant.json`, que configura o comportamento do servidor/runtime.
