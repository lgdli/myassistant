...
MyAssistant Zen é uma lista de modelos fornecidos pela equipe do opencode que foram testados e verificados para funcionar bem com o opencode. [Saiba mais](/docs/zen).

:::tip
Se você é novo, recomendamos começar com o MyAssistant Zen.
:::

1. Execute o comando `/connect` no TUI, selecione `MyAssistant Zen` e acesse [opencode.ai/zen](https://opencode.ai/zen).
...
MyAssistant Go é um plano de assinatura de baixo custo que fornece acesso confiável a modelos de codificação abertos populares fornecidos pela equipe do opencode que foram
testados e verificados para funcionar bem com o opencode.

1. Execute o comando `/connect` no TUI, selecione `MyAssistant Go` e acesse [opencode.ai/zen](https://opencode.ai/zen).
...
MyAssistant Zen é uma lista de modelos testados e verificados fornecidos pela equipe do opencode. [Saiba mais](/docs/zen).
