...
Opprett `.myassistant/commands/test.md`:
...
Du kan legge til egendefinerte kommandoer gjennom MyAssistant-konfigurasjonen eller ved å lage markdown-filer i katalogen `commands/`.

---

### JSON

Bruk alternativet `command` i MyAssistant [config](/docs/config):
...
- Per prosjekt: `.myassistant/commands/`
...
MyAssistant inkluderer flere innebygde kommandoer som `/init`, `/undo`, `/redo`, `/share`, `/help`; [finn ut mer](/docs/tui#commands).
