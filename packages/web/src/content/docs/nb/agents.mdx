...
Modellen ID i MyAssistant-konfigurasjonen din bruker formatet `provider/model-id`. For eksempel, hvis du bruker [MyAssistant Zen](/docs/zen), vil du bruke `opencode/gpt-5.1-codex` for GPT 5.1 Codex.
