...
Agentferdigheter lar MyAssistant oppdage gjenbrukbare instruksjoner fra repo- eller hjemmekatalogen din.
...
For prosjektlokale stier går myassistant opp fra din nåværende arbeidskatalog til den når git-arbeidstreet.
...
myassistant viser tilgjengelige ferdigheter i `skill`-verktøybeskrivelsen.
...
Kontroller hvilke ferdigheter agenter har tilgang til ved å bruke mønsterbaserte tillatelser i `myassistant.json`:
