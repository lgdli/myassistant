---
title: LSP-servere
description: myassistant integreres med LSP-serverne dine.
---

MyAssistant integreres med din Language Server Protocol (LSP) for å hjelpe LLM med å samhandle med kodebasen din. Den bruker diagnostikk for å gi tilbakemelding til LLM.

---

## Innebygde servere

MyAssistant kommer med flere innebygde LSP-servere for populære språk:
...
Når myassistant åpner en fil, gjør den:
...
Du kan tilpasse LSP-servere gjennom `lsp`-delen i MyAssistant-konfigurasjonen.
