...
1. Kjør kommandoen `/connect` i TUI, velg `MyAssistant Zen` og gå til [opencode.ai/auth](https://opencode.ai/zen).
...
1. Kjør kommandoen `/connect` i TUI, velg `MyAssistant Go`, og gå til [opencode.ai/auth](https://opencode.ai/zen).
...
Helicones [Sessions](https://docs.helicone.ai/features/sessions) funksjon lar deg gruppere relaterte LLM forespørsler sammen. Bruk [opencode-helicone-session](https://github.com/H2Shami/opencode-helicone-session) plugin for automatisk å logge hver MyAssistant-samtale som en økt i Helicone.
...
:::tip
Ollama kan automatisk konfigurere seg selv for MyAssistant. Se [Ollama-integrasjonsdokumentene](https://docs.ollama.com/integrations/opencode) for detaljer.
:::
