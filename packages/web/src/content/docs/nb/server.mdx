...
Kommandoen `opencode serve` kjører en hodeløs HTTP-server som eksponerer et OpenAPI-endepunkt som en MyAssistant-klient kan bruke.
...
MyAssistant TUI kjører, vil `opencode serve` starte en ny server.
