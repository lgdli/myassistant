---
title: TUI
description: Bruke myassistant-terminalbrukergrensesnittet.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

MyAssistant gir et interaktivt terminalgrensesnitt (TUI) for å jobbe med prosjektene dine med en LLM.

Å kjøre MyAssistant starter TUI for gjeldende katalog.
...
Når du bruker MyAssistant TUI, kan du skrive `/` etterfulgt av et kommandonavn for raskt å utføre handlinger. For eksempel:
...
Legg til en leverandør til MyAssistant. Lar deg velge fra tilgjengelige leverandører og legge til deres API-nøkler.
...
Avslutt MyAssistant. _Aliaser_: `/quit`, `/q`
...
Dette er atskilt fra `myassistant.json`, som konfigurerer server-/kjøretidsoppførsel.
