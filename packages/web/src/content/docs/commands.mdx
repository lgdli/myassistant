...
Create `.myassistant/commands/test.md`:
...
You can add custom commands through the MyAssistant config or by creating markdown files in the `commands/` directory.

---

### JSON

Use the `command` option in your MyAssistant [config](/docs/config):
...
- Per-project: `.myassistant/commands/`
...
myassistant includes several built-in commands like `/init`, `/undo`, `/redo`, `/share`, `/help`; [learn more](/docs/tui#commands).
