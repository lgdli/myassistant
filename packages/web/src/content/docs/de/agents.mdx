...
Die Modell-ID in Ihrer MyAssistant-Konfiguration verwendet das Format `provider/model-id`. Wenn Sie beispielsweise [MyAssistant Zen](/docs/zen) verwenden, würden Sie `opencode/gpt-5.1-codex` für GPT 5.1 Codex verwenden.
