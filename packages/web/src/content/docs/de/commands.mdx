...
Erstellen Sie `.myassistant/commands/test.md`:

```md title=".myassistant/commands/test.md"
---
...
Sie können benutzerdefinierte Befehle über die MyAssistant-Konfiguration hinzufügen oder indem Sie Markdown-Dateien im Verzeichnis `commands/` erstellen.

---

### JSON

Verwenden Sie die Option `command` in Ihrem MyAssistant [config](/docs/config):

```json title="myassistant.jsonc" {4-12}
{
...
- Global: `~/.config/myassistant/commands/`
- Pro Projekt: `.myassistant/commands/`

```markdown title="~/.config/myassistant/commands/test.md"
---
description: Run tests with coverage
agent: build
model: anthropic/claude-3-5-sonnet-20241022
...
```md title=".myassistant/commands/component.md"
---
...
```md title=".myassistant/commands/create-file.md"
---
...
```md title=".myassistant/commands/analyze-coverage.md"
---
...
```md title=".myassistant/commands/review-changes.md"
---
...
```md title=".myassistant/commands/review-component.md"
---
...
MyAssistant enthält mehrere integrierte Befehle wie `/init`, `/undo`, `/redo`, `/share`, `/help`; [mehr erfahren](/docs/tui#commands).
