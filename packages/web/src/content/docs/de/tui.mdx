---
title: TUI
description: Arbeite mit MyAssistant in der Terminal-Oberflaeche.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

MyAssistant bietet eine interaktive Terminaloberflaeche (TUI), um mit einem LLM an deinen Projekten zu arbeiten.

Ohne weitere Argumente startet MyAssistant die TUI im aktuellen Verzeichnis.
...
In der MyAssistant-TUI kannst du `/` plus Befehlsnamen eingeben, um Aktionen schnell auszufuehren.
Zum Beispiel:
...
Fuegt einen Provider zu MyAssistant hinzu. Erlaubt die Auswahl aus verfuegbaren Providern und das Hinzufuegen ihrer API-Keys.
...
Beendet MyAssistant. _Aliase_: `/quit`, `/q`
...
Dies ist getrennt von `myassistant.json`, welche das Server-/Runtime-Verhalten konfiguriert.
