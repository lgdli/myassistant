---
title: Teilen
description: Teile MyAssistant-Unterhaltungen per oeffentlichem Link.
---

Mit der Share-Funktion erstellst du oeffentliche Links zu MyAssistant-Unterhaltungen.
...
Wenn du eine Unterhaltung teilst, macht MyAssistant Folgendes:
...
MyAssistant hat drei Modi, die das Teilen steuern:

---

### Manuell (Standard)

Standardmaessig nutzt MyAssistant den manuellen Modus.
...
Wenn das fuer ein Projekt teamweit gelten soll, lege es in der Projekt-`myassistant.json` fest und committe die Datei.
...
[Mehr dazu](/docs/enterprise), wie du myassistant in deiner Organisation einsetzt.
