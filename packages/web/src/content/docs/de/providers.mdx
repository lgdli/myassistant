...
1. Führen Sie den Befehl `/connect` in TUI aus, wählen Sie MyAssistant aus und gehen Sie zu [opencode.ai/auth](https://opencode.ai/auth).
...
1. Führen Sie den Befehl `/connect` in der TUI aus, waehlen Sie `MyAssistant Go` und gehen Sie zu [opencode.ai/auth](https://opencode.ai/zen).
...
Mit der [Sessions](https://docs.helicone.ai/features/sessions)-Funktion von Helicone können Sie zusammengehörige LLM-Anfragen gruppieren. Verwenden Sie das [opencode-helicone-session](https://github.com/H2Shami/opencode-helicone-session)-Plugin, um jede MyAssistant-Konversation automatisch als Sitzung in Helicone zu protokollieren.
...
:::tip
Ollama kann sich automatisch für MyAssistant konfigurieren. Weitere Informationen finden Sie unter [Ollama integration docs](https://docs.ollama.com/integrations/opencode).
:::
