---
title: SDK
description: Typsicherer JS-Client fuer den myassistant-Server.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

Das myassistant JS/TS SDK bietet einen typsicheren Client fuer die Server-API.
Damit kannst du Integrationen bauen und myassistant programmatisch steuern.
...
Erstelle eine myassistant-Instanz:
...
`myassistant.json` wird weiterhin geladen, kann aber inline ueberschrieben oder erweitert werden:
...
Wenn myassistant bereits laeuft, kannst du nur einen Client erstellen und verbinden:
