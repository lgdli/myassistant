---
title: ACP podrška
description: Koristite MyAssistant u bilo kojem uređivaču kompatibilnom sa ACP.
---

MyAssistant podržava [Agent Client Protocol](https://agentclientprotocol.com) (ACP), što vam omogućava da ga koristite direktno u kompatibilnim uređivačima i IDE-ovima.
...
Da biste koristili MyAssistant putem ACP-a, konfigurirajte svoj uređivač da pokrene naredbu `myassistant acp`.

Naredba pokreće MyAssistant kao ACP-kompatibilan podproces koji komunicira sa vašim uređivačem preko JSON-RPC-a kroz stdio.
...
Da biste ga otvorili, koristite novog "MyAssistant" agenta u AI Chat agent selektoru.
...
Da koristite MyAssistant kao ACP agenta u [CodeCompanion.nvim](https://github.com/olimorris/codecompanion.nvim), dodajte sljedeće u svoju Neovim konfiguraciju:
...
Ova konfiguracija postavlja CodeCompanion da koristi MyAssistant kao ACP chat agenta.
...
MyAssistant radi isto kroz ACP kao i u terminalu. Podržane su sve funkcije:
...
- MCP serveri konfigurisani u vašoj MyAssistant konfiguraciji
