...
Kreiraj `.myassistant/commands/test.md`:
...
Možete dodati prilagođene komande kroz MyAssistant konfiguraciju ili kreiranjem markdown datoteka u direktoriju `commands/`.

---

### JSON

Koristite opciju `command` u svom MyAssistant [config](/docs/config):
...
- Globalno: `~/.config/myassistant/commands/`
- Po projektu: `.myassistant/commands/`
...
MyAssistant uključuje nekoliko ugrađenih naredbi kao što su `/init`, `/undo`, `/redo`, `/share`, `/help`; [saznaj više](/docs/tui#commands).
:::note
