---
title: TUI
description: Korištenje korisničkog interfejsa MyAssistant terminala.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

MyAssistant pruža interaktivni terminalski interfejs ili TUI za rad na vašim projektima sa LLM.

Pokretanje MyAssistant pokreće TUI za trenutni direktorij.
...
Kada koristite MyAssistant TUI, možete upisati `/` nakon čega slijedi ime komande da biste brzo izvršili radnje. na primjer:
...
Dodajte provajdera u MyAssistant. Omogućava vam da odaberete između dostupnih provajdera i dodate njihove API ključeve.
...
Izađite iz MyAssistant. _Aliases_: `/quit`, `/q`
...
Ovo je odvojeno od `myassistant.json`, koji konfiguriše ponašanje servera/izvršavanja.
