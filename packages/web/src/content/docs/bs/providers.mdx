...
1. Pokrenite naredbu `/connect` u TUI-u, odaberite `MyAssistant Go` i idite na [opencode.ai/auth](https://opencode.ai/zen).
...
Heliconeova funkcija [Sessions](https://docs.helicone.ai/features/sessions) vam omogućava da grupišete povezane LLM zahtjeve zajedno. Koristite dodatak [opencode-helicone-session](https://github.com/H2Shami/opencode-helicone-session) da automatski prijavite svaki MyAssistant razgovor kao sesiju u Helicone-u.
...
:::tip
Ollama se može automatski konfigurirati za MyAssistant. Pogledajte [Ollama integracijske dokumente](https://docs.ollama.com/integrations/opencode) za detalje.
:::
