---
title: ACP
description: Używanie MyAssistant z protokołem Agent Client Protocol (ACP).
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

MyAssistant obsługuje [Agent Client Protocol](https://agentclientprotocol.com) (ACP), który umożliwia korzystanie z MyAssistant bezpośrednio w edytorach i środowiskach IDE.
...
Aby używać MyAssistant przez ACP, skonfiguruj swój edytor tak, aby uruchamiał polecenie `myassistant acp`.

Uruchamia to MyAssistant jako podproces zgodny z ACP, który komunikuje się z edytorem za pomocą JSON-RPC przez stdio.
...
Następnie wybierz „MyAssistant” w selektorze agentów AI Chat.
...
Aby używać MyAssistant jako agenta ACP w [CodeCompanion.nvim](https://github.com/olimorris/codecompanion.nvim), dodaj następującą konfigurację do Neovim:
...
Ta konfiguracja sprawia, że CodeCompanion używa MyAssistant jako agenta ACP do czatu.
...
MyAssistant działa przez ACP tak samo, jak w terminalu. Obsługiwane są wszystkie główne funkcje:
...
- Serwery MCP zdefiniowane w konfiguracji MyAssistant
