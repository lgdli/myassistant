---
title: TUI
description: Korzystanie z interfejsu użytkownika terminala myassistant.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

myassistant zapewnia interaktywny interfejs terminala lub TUI do pracy nad projektami za pomocą LLM.

Uruchomienie myassistant uruchamia TUI dla bieżącego katalogu.
...
Korzystając z TUI myassistant, możesz wpisać `/`, po którym następuje nazwa polecenia, aby szybko wykonać działania. Na przykład:
...
Dodaj dostawcę do myassistant. Umożliwia wybór dostępnych dostawców i dodanie ich kluczy API.
...
Zamknij myassistant. _Aliasy_: `/quit`, `/q`
...
Jest to oddzielny plik od `myassistant.json`, który konfiguruje zachowanie serwera/runtime.
