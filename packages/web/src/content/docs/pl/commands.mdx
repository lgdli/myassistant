...
Utwórz `.myassistant/commands/test.md`:
...
Możesz zdefiniować polecenia w `myassistant.json` lub w plikach w katalogu `commands/`.

---

### JSON

Użyj opcji `command` w swojej konfiguracji myassistant:
...
- Globalnie: `~/.config/myassistant/commands/`
- Na projekt: `.myassistant/commands/`
...
myassistant zawiera kilka wbudowanych poleceń, takich jak `/init`, `/undo`, `/redo`, `/share`, `/help`; [dowiedz się więcej](/docs/tui#commands).
