---
title: Zen
description: Wyselekcjonowana lista modeli dostarczonych przez MyAssistant.
---
...
MyAssistant Zen to lista przetestowanych i zweryfikowanych modeli udostępniana przez zespół MyAssistant.

:::note
MyAssistant Zen jest obecnie w wersji beta.
:::

Zen działa jak każdy inny dostawca w MyAssistant. Logujesz się do MyAssistant Zen i otrzymujesz
...
:::tip
Przetestowaliśmy wybraną grupę modeli i dostawców, którzy dobrze współpracują z MyAssistant.
:::
...
MyAssistant Zen to brama AI, która daje dostęp do tych modeli.

---

## Jak to działa

MyAssistant Zen działa jak każdy inny dostawca w MyAssistant.

1. Logujesz się do **<a href={console}>MyAssistant Zen</a>**, dodajesz dane
   rozliczeniowe i kopiujesz swój klucz API.
2. Uruchamiasz polecenie `/connect` w TUI, wybierasz MyAssistant Zen i wklejasz swój klucz API.
...
[ID modelu](/docs/config/#models) w Twojej konfiguracji MyAssistant używa formatu
`myassistant/<model-id>`. Na przykład dla GPT 5.5 użyjesz w konfiguracji
`myassistant/gpt-5.5`.
...
- MiniMax M2.5 Free jest dostępny w MyAssistant przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- Ling 2.6 Flash Free jest dostępny w MyAssistant przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- Hy3 Preview Flash Free jest dostępny w MyAssistant przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- Nemotron 3 Super Free jest dostępny w MyAssistant przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- Big Pickle to stealth model, który jest darmowy w MyAssistant przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
...
Stworzyliśmy MyAssistant Zen, aby:
...
4. Nie tworzyć **lock-in**, pozwalając używać tego z dowolnym innym agentem kodującym. I zawsze pozwalać Ci używać w MyAssistant także dowolnego innego dostawcy.
