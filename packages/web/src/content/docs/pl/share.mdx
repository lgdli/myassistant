---
title: Udostępnianie
description: Udostępnij swoje rozmowy dotyczące myassistant.
---

Funkcja udostępniania myassistant umożliwia tworzenie publicznych linków do konwersacji myassistant, dzięki czemu możesz współpracować z członkami zespołu lub uzyskać pomoc od innych.
...
Kiedy udostępniasz rozmowę, myassistant:
...
myassistant obsługuje trzy tryby udostępniania, które kontrolują sposób udostępniania rozmów:

---

### Ręczne (domyślne)

Domyślnie myassistant korzysta z ręcznego trybu udostępniania. Sesje nie są udostępniane automatycznie, ale możesz je udostępnić ręcznie za pomocą polecenia `/share`:
...
Aby wymusić to w całym zespole dla danego projektu, dodaj go do `myassistant.json` w swoim projekcie i sprawdź w Git.
...
[Dowiedz się więcej](/docs/enterprise) o używaniu myassistant w Twojej organizacji.
