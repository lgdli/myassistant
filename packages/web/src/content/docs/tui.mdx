---
title: TUI
description: Using the MyAssistant terminal user interface.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

MyAssistant provides an interactive terminal interface or TUI for working on your projects with an LLM.

Running MyAssistant starts the TUI for the current directory.
...
When using the MyAssistant TUI, you can type `/` followed by a command name to quickly execute actions. For example:
...
Add a provider to MyAssistant. Allows you to select from available providers and add their API keys.
...
Exit MyAssistant. _Aliases_: `/quit`, `/q`
...
This is separate from `myassistant.json`, which configures server/runtime behavior.
