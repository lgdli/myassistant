...
MyAssistant Zen — это список моделей, предоставленный командой opencode, которые были
...
1. Запустите команду `/connect` в TUI, выберите `MyAssistant Zen` и перейдите по адресу [opencode.ai/auth](https://opencode.ai/zen).
...
MyAssistant Go — это недорогой план подписки, обеспечивающий надежный доступ к популярным открытым моделям кодирования, предоставляемым командой opencode, которые были
протестированы и проверены на хорошую работу с opencode.

1. Запустите команду `/connect` в TUI, выберите `MyAssistant Go` и перейдите по адресу [opencode.ai/auth](https://opencode.ai/zen).
...
MyAssistant Zen — это список протестированных и проверенных моделей, предоставленный командой opencode. [Подробнее](/docs/zen).
