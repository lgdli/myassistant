---
title: TUI
description: MyAssistant terminal kullanıcı arayüzünü kullanma.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

MyAssistant, projelerinizde LLM ile çalışmak için etkileşimli bir terminal arayüzü (TUI) sunar.

MyAssistant'u çalıştırdığınızda mevcut dizin için TUI başlar.
...
MyAssistant TUI kullanırken `/` ve ardından komut adını yazarak hızlı eylemler çalıştırabilirsiniz. Örneğin:
...
MyAssistant'a bir sağlayıcı ekler. Mevcut sağlayıcıları seçip API anahtarları eklemenizi sağlar.
...
MyAssistant'dan çıkar. _Takma adlar_: `/quit`, `/q`
...
Bu, sunucu/çalışma zamanı davranışını yapılandıran `myassistant.json` dosyasından ayrıdır.
