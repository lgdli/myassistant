...
description: MyAssistant, LSP sunucularınızla bütünleşir.
---

MyAssistant, LLM'in kod tabanınızla etkileşime girmesine yardımcı olmak için Dil Sunucusu Protokolünüzle (LSP) bütünleşir. LLM'ye geri bildirim sağlamak için tanılamayı kullanır.

---

## Yerleşik

MyAssistant, popüler diller için çeşitli yerleşik LSP sunucularıyla birlikte gelir:
...
myassistant bir dosyayı açtığında:
...
LSP sunucularını, myassistant yapılandırmanızdaki `lsp` bölümü aracılığıyla özelleştirebilirsiniz.
