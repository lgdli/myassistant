---
title: Paylasim
description: myassistant konusmalarini genel baglantilarla paylasin.
---

myassistant'un paylasim ozelligi, konusmalariniz icin genel baglantilar olusturmanizi saglar. Boylece ekip arkadaslarinizla birlikte calisabilir veya diger kisilerden yardim alabilirsiniz.
...
Bir konusmayi paylastiginizda myassistant:
...
myassistant, konusmalarin nasil paylasilacagini kontrol eden uc farkli paylasim modu sunar:

---

### Manuel (varsayilan)

Varsayilan olarak myassistant manuel paylasim modunu kullanir. Oturumlar otomatik paylasilmaz, ancak `/share` komutuyla manuel olarak paylasabilirsiniz:
...
Bunu belirli bir projede tum ekip icin zorunlu kilmak icin proje icindeki `myassistant.json` dosyasina ekleyip Git'e commit edin.
...
Kurulusunuzda myassistant kullanimi icin [daha fazla bilgi alin](/docs/enterprise).
