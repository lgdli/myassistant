---
title: Özel Araçlar
description: LLM'un myassistant'da çağırabileceği araçları birleştirebilir.
---

Özel araçlar, LLM'un konuşmalar sırasında arayabileceği, oluşturduğunuz işlevlerdir. myassistant'un [built-in tools](/docs/tools) ile birlikte `read`, `write` ve `bash` gibi çalışırlar.
...
- Yerel olarak bunları projenizin `.myassistant/tools/` dizinine yerleştirerek.
- Veya küresel olarak bunları `~/.config/myassistant/tools/` içine yerleştirerek.
