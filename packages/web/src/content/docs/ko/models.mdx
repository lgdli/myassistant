...
전체 ID는 `provider_id/model_id`입니다. 예를 들어, [MyAssistant Zen](/docs/zen)을 사용한다면, GPT 5.1 Codex에 `myassistant/gpt-5.1-codex`를 사용할 수 있습니다.
