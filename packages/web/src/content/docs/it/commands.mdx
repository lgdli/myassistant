...
Crea `.myassistant/commands/test.md`:
...
Puoi aggiungere comandi personalizzati tramite la config di MyAssistant o creando file markdown nella directory `commands/`.

---

### JSON

Usa l'opzione `command` nella [config](/docs/config) di MyAssistant:
...
- Globale: `~/.config/myassistant/commands/`
- Per progetto: `.myassistant/commands/`
...
myassistant include diversi comandi integrati come `/init`, `/undo`, `/redo`, `/share`, `/help`; [scopri di piu](/docs/tui#commands).
