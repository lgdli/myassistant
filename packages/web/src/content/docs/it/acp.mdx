---
title: Supporto ACP
description: Usa MyAssistant in qualunque editor compatibile con ACP.
---

MyAssistant supporta [Agent Client Protocol](https://agentclientprotocol.com) (ACP), permettendoti di usarlo direttamente in editor e IDE compatibili.
...
Per usare MyAssistant via ACP, configura l'editor in modo che esegua il comando `myassistant acp`.

Il comando avvia MyAssistant come sottoprocesso compatibile con ACP che comunica con l'editor via JSON-RPC su stdio.
...
Per aprirlo, seleziona il nuovo agente 'MyAssistant' nel selettore agenti di AI Chat.
...
Per usare MyAssistant come agente ACP in [CodeCompanion.nvim](https://github.com/olimorris/codecompanion.nvim), aggiungi quanto segue alla config di Neovim:
...
Questa config imposta CodeCompanion per usare MyAssistant come agente ACP per la chat.
...
MyAssistant funziona via ACP come nel terminale. Tutte le funzionalita sono supportate:
:::note
...
- Server MCP configurati nella tua configurazione MyAssistant
