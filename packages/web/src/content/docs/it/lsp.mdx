---
title: Server LSP
description: MyAssistant si integra con i tuoi server LSP.
---

MyAssistant si integra con il tuo Language Server Protocol (LSP) per aiutare l'LLM a interagire con la tua codebase. Usa le diagnostiche per fornire feedback all'LLM.

---

## Integrati

MyAssistant include diversi server LSP integrati per linguaggi popolari:
...
Quando myassistant apre un file:
...
Puoi personalizzare i server LSP tramite la sezione `lsp` nella configurazione di myassistant.
