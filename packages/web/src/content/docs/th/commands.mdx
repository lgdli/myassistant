...
สร้าง `.myassistant/commands/test.md`:
...
ใช้ส่วน `command` ในไฟล์ [config](/docs/config) ของ MyAssistant:
...
- ระดับผู้ใช้ (Global): `~/.config/myassistant/commands/`
- ระดับโปรเจ็กต์: `.myassistant/commands/`
...
MyAssistant มีคำสั่งในตัวหลายคำสั่ง เช่น `/init`, `/undo`, `/redo`, `/share`, `/help` [เรียนรู้เพิ่มเติม](/docs/tui#คำสั่ง)
