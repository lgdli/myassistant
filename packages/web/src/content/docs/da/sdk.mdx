...
Brug den til at bygge integrasjoner og kontrollere myassistant programmatisk.
...
Opret en forekomst av myassistant:
...
Du kan sende et konfigurasjonsobjekt for at tilpasse virkemåten. Forekomsten henter fortsatt din `myassistant.json`, men du kan overstyre eller tilføje til konfigurasjon inline:
...
Hvis du allerede har en kjørende forekomst av myassistant, kan du oprete en klientforekomst for at koble til den:
