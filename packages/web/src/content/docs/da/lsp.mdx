---
title: LSP-servere
description: MyAssistant integreres med dine LSP-servere.
---

MyAssistant integreres med Language Server Protocol (LSP) for at hjælpe LLM med at interagere med din kodebase. Den bruger diagnostik til at give feedback til LLM.

---

## Indbyggede

MyAssistant leveres med flere indbyggede LSP-servere til populære sprog:
...
Når myassistant åbner en fil, vil den:
...
Du kan tilpasse LSP-servere gennem sektionen `lsp` i din myassistant-konfiguration.
