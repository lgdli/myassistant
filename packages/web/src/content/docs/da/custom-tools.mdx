...
description: Opret værktøjer, som LLM kan kalde myassistant ind.
---
...
- Lokalt ved at placere dem i biblioteket `.myassistant/tools/` i dit projekt.
- Eller globalt ved at placere dem i `~/.config/myassistant/tools/`.
