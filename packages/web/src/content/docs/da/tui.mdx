---
title: TUI
description: Brug af MyAssistant-terminalbrugergrænsefladen.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

MyAssistant giver en interaktiv terminalgrænseflade eller TUI til at arbejde med dine projekter med en LLM.

At køre MyAssistant starter TUI for den nuværende mappe.
...
Når du bruger MyAssistant TUI, kan du skrive `/` efterfulgt af et kommandonavn for hurtigt at udføre handlinger. For eksempel:
...
Tilføj en udbyder til MyAssistant. Lader dig vælge fra tilgængelige udbydere og tilføje deres API-nøgler.
...
Afslut MyAssistant. _Aliaser_: `/quit`, `/q`
...
Dette er adskilt fra `myassistant.json`, som konfigurerer server-/kørselstidsadfærd.
