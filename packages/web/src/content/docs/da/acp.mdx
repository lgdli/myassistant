...
description: Brug MyAssistant i enhver ACP-kompatibel editor.
---

MyAssistant understøtter [Agent Client Protocol](https://agentclientprotocol.com) eller (ACP), så du kan bruge det direkte i kompatible editorer og IDE'er.
...
For at bruge MyAssistant via ACP, konfigurer din editor til at køre kommandoen `myassistant acp`.

Kommandoen starter MyAssistant som en ACP-kompatibel underproces, der kommunikerer med din editor over JSON-RPC via stdio.
...
For at åbne den skal du bruge den nye 'MyAssistant'-agent i AI Chat-agentvælgeren.
...
For at bruge MyAssistant som en ACP-agent i [CodeCompanion.nvim](https://github.com/olimorris/codecompanion.nvim), skal du tilføje følgende til din Neovim-konfiguration:
...
Denne konfiguration sætter CodeCompanion til at bruge MyAssistant som ACP-agent til chat.
...
MyAssistant fungerer på samme måde via ACP som i terminalen. Alle funktioner understøtter:
...
- MCP-servere konfigureret i din MyAssistant-konfiguration
