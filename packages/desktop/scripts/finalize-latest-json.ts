...
const releaseId = process.env.MYASSISTANT_RELEASE
if (!releaseId) throw new Error("MYASSISTANT_RELEASE is required")

const version = process.env.MYASSISTANT_VERSION
if (!version) throw new Error("MYASSISTANT_VERSION is required")
...
const macxTarGz = "myassistant-desktop-mac-x64.app.tar.gz"
const macaTarGz = "myassistant-desktop-mac-arm64.app.tar.gz"
