export const dict = {
  ...
  "desktop.menu.help.documentation": "Documentation d'MyAssistant",
  ...
  "desktop.cli.error.sidecarMissing":
    "Le binaire de la CLI MyAssistant est manquant. Essayez de réinstaller l'application de bureau.",
