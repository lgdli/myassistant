export const dict = {
  ...
  "desktop.menu.help.documentation": "MyAssistant Dokumentasjon",
  ...
  "desktop.cli.error.sidecarMissing": "MyAssistant CLI-binærfil mangler. Prøv å installere skrivebordsappen på nytt.",
