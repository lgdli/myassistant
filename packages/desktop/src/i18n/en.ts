export const dict = {
  ...
  "desktop.menu.help.documentation": "MyAssistant Documentation",
  ...
  "desktop.cli.error.sidecarMissing": "MyAssistant CLI binary is missing. Try reinstalling the desktop app.",
