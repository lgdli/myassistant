...
export class App extends HeyApiClient {
   ...
   * List agents
   *
   * Get a list of all available AI agents in the MyAssistant system.
   */
   ...
   * List skills
   *
   * Get a list of all available skills in the MyAssistant system.
   */
...
export class Config extends HeyApiClient {
   ...
   *
   * Retrieve the current global MyAssistant configuration settings and preferences.
   */
   ...
   *
   * Update global MyAssistant configuration settings and preferences.
   */
...
export class Global extends HeyApiClient {
   ...
   * Get health
   *
   * Get health information about the MyAssistant server.
   */
   ...
   * Get global events
   *
   * Subscribe to global events from the MyAssistant system using server-sent events.
   */
   ...
   * Dispose instance
   *
   * Clean up and dispose all MyAssistant instances, releasing all resources.
   */
   ...
   * Upgrade myassistant
   *
   * Upgrade myassistant to the specified version or latest if not specified.
   */
...
export class Config2 extends HeyApiClient {
   ...
   * Get configuration
   *
   * Retrieve the current MyAssistant configuration settings and preferences.
   */
   ...
   *
   * Update MyAssistant configuration settings and preferences.
   */
  public update<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
...
export class Console extends HeyApiClient {
   ...
   *
   * Persist a new active Console account/org selection for the current local MyAssistant state.
   */
...
export class Instance extends HeyApiClient {
   ...
   * Dispose instance
   *
   * Clean up and dispose the current MyAssistant instance, releasing all resources.
   */
...
export class Command extends HeyApiClient {
   ...
   * List commands
   *
   * Get a list of all available commands in the MyAssistant system.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
...
export class Project extends HeyApiClient {
   ...
   * List all projects
   *
   * Get a list of projects that have been opened with MyAssistant.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
   ...
   * Get current project
   *
   * Retrieve the currently active project that MyAssistant is working with.
   */
...
export class Pty extends HeyApiClient {
   ...
   * List PTY sessions
   *
   * Get a list of all active pseudo-terminal (PTY) sessions managed by MyAssistant.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
...
export class Session2 extends HeyApiClient {
   ...
   * List sessions
   *
   * Get a list of all MyAssistant sessions, sorted by most recently updated.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
   ...
   * Create session
   *
   * Create a new MyAssistant session for interacting with AI assistants and managing conversations.
   */
  public create<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
   ...
   * Get session
   *
   * Retrieve detailed information about a specific MyAssistant session.
   */
  public get<ThrowOnError extends boolean = false>(
    parameters: {
      sessionID: string
