...
import desktopAppIcon from "../../asset/lander/myassistant-desktop-icon.png"
      ...
      <div data-component="container">
        ...
        <div data-component="content">
          ...
          <section data-component="download-section">
            ...
            <div data-component="section-content">
              <button
                ...
                onClick={handleCopyClick("curl -fsSL https://myassistant.ai/install | bash")}
              >
                <code>
                  curl -fsSL https://<strong>myassistant.ai/install</strong> | bash
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("npm i -g myassistant-ai")}>
                <code>
                  npm i -g <strong>myassistant-ai</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("bun add -g myassistant-ai")}>
                <code>
                  bun add -g <strong>myassistant-ai</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("brew install anomalyco/tap/myassistant")}>
                <code>
                  brew install <strong>anomalyco/tap/myassistant</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("paru -S myassistant")}>
                <code>
                  paru -S <strong>myassistant</strong>
                </code>
                <CopyStatus />
              </button>
            </div>
          ...
          <section data-component="download-section">
            ...
            <div data-component="section-content">
              <button data-component="cli-row" onClick={handleCopyClick("brew install --cask myassistant-desktop")}>
                <code>
                  brew install --cask <strong>myassistant-desktop</strong>
                </code>
                <CopyStatus />
              </button>
