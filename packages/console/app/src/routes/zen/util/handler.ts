...
import { and, Database, eq, isNull, lt, or, sql } from "@myassistant-ai/console-core/drizzle/index.js"
import { KeyTable } from "@myassistant-ai/console-core/schema/key.sql.js"
import { BillingTable, LiteTable, SubscriptionTable, UsageTable } from "@myassistant-ai/console-core/schema/billing.sql.js"
import { centsToMicroCents } from "@myassistant-ai/console-core/util/price.js"
import { getMonthlyBounds, getWeekBounds } from "@myassistant-ai/console-core/util/date.js"
import { Identifier } from "@myassistant-ai/console-core/identifier.js"
import { Billing } from "@myassistant-ai/console-core/billing.js"
import { Actor } from "@myassistant-ai/console-core/actor.js"
import { WorkspaceTable } from "@myassistant-ai/console-core/schema/workspace.sql.js"
import { ZenData } from "@myassistant-ai/console-core/model.js"
import { Subscription } from "@myassistant-ai/console-core/subscription.js"
import { BlackData } from "@myassistant-ai/console-core/black.js"
import { UserTable } from "@myassistant-ai/console-core/schema/user.sql.js"
import { ModelTable } from "@myassistant-ai/console-core/schema/model.sql.js"
import { ProviderTable } from "@myassistant-ai/console-core/schema/provider.sql.js"
...
import { LiteData } from "@myassistant-ai/console-core/lite.js"
import { Resource } from "@myassistant-ai/console-resource"
...
export async function handler(
  ...
  try {
    ...
    const sessionId = input.request.headers.get("x-myassistant-session") ?? ""
    const requestId = input.request.headers.get("x-myassistant-request") ?? ""
    const projectId = input.request.headers.get("x-myassistant-project") ?? ""
    const ocClient = input.request.headers.get("x-myassistant-client") ?? ""
    ...
    const retriableRequest = async (retry: RetryOptions = { excludeProviders: [], retryCount: 0 }) => {
      ...
      const res = await fetchWith429Retry(reqUrl, {
        ...
        headers: (() => {
          ...
          headers.delete("x-myassistant-request")
          headers.delete("x-myassistant-session")
          headers.delete("x-myassistant-project")
          headers.delete("x-myassistant-client")
          return headers
        })(),
        body: reqBody,
      })
  ...
  function validateBilling(authInfo: AuthInfo, modelInfo: ModelInfo): BillingSource {
    ...
    const billingUrl = `https://myassistant.ai/workspace/${authInfo.workspaceID}/billing`
    const membersUrl = `https://myassistant.ai/workspace/${authInfo.workspaceID}/members`
