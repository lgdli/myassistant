...
import compareVideo from "../../asset/lander/myassistant-comparison-min.mp4"
import compareVideoPoster from "../../asset/lander/myassistant-comparison-poster.png"
...
export default function Home() {
  ...
  return (
    <main data-page="zen">
      ...
      <Meta name="myassistant:auth" content={loggedin() ? "true" : "false"} />
