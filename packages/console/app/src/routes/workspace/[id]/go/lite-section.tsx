...
import { Database, eq, and, isNull } from "@myassistant-ai/console-core/drizzle/index.js"
import { BillingTable, LiteTable } from "@myassistant-ai/console-core/schema/billing.sql.js"
        ...
        {(sub) => (
          <section class={styles.root}>
            ...
            <div data-slot="beta-notice">
              ...
              <a href={language.route("/docs/providers/#myassistant-go")} target="_blank" rel="noopener noreferrer">
