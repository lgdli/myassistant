...
const { Flag } = await import("@myassistant-ai/core/flag/flag")
...
const experimental = Flag.MYASSISTANT_EXPERIMENTAL_WORKSPACES

Flag.MYASSISTANT_EXPERIMENTAL_WORKSPACES = true
...
afterAll(() => {
  ...
  Flag.MYASSISTANT_EXPERIMENTAL_WORKSPACES = experimental
})
