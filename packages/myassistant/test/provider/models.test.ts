...
// test/preload.ts pins MYASSISTANT_MODELS_PATH to a fixture so other tests can
...
// bun process.
const ORIGINAL_MODELS_PATH = Flag.MYASSISTANT_MODELS_PATH
const ORIGINAL_DISABLE_FETCH = Flag.MYASSISTANT_DISABLE_MODELS_FETCH
beforeAll(() => {
  Flag.MYASSISTANT_MODELS_PATH = undefined
  Flag.MYASSISTANT_DISABLE_MODELS_FETCH = true
})
afterAll(() => {
  Flag.MYASSISTANT_MODELS_PATH = ORIGINAL_MODELS_PATH
  Flag.MYASSISTANT_DISABLE_MODELS_FETCH = ORIGINAL_DISABLE_FETCH
})
