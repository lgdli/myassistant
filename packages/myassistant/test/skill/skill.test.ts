...
const withHome = <A, E, R>(home: string, self: Effect.Effect<A, E, R>) =>
  Effect.acquireUseRelease(
    Effect.sync(() => {
      const prev = process.env.MYASSISTANT_TEST_HOME
      process.env.MYASSISTANT_TEST_HOME = home
      return prev
    }),
    () => self,
    (prev) =>
      Effect.sync(() => {
        process.env.MYASSISTANT_TEST_HOME = prev
      }),
  )

describe("skill", () => {
  it.live("discovers skills from .myassistant/skill/ directory", () =>
    provideTmpdirInstance(
      (dir) =>
        Effect.gen(function* () {
          yield* Effect.promise(() =>
            Bun.write(
              path.join(dir, ".myassistant", "skill", "test-skill", "SKILL.md"),
              `---
name: test-skill
      ...
      (dir) =>
        withHome(
          ...
          Effect.gen(function* () {
            yield* Effect.promise(() =>
              Bun.write(
                path.join(dir, ".myassistant", "skill", "dir-skill", "SKILL.md"),
                `---
name: dir-skill
...
`,
            ...
            expect(dirs).toContain(path.join(dir, ".myassistant", "skill", "dir-skill"))
  ...
  it.live("discovers multiple skills from .myassistant/skill/ directory", () =>
    provideTmpdirInstance(
      (dir) =>
        Effect.gen(function* () {
          yield* Effect.promise(() =>
            Promise.all([
              Bun.write(
                path.join(dir, ".myassistant", "skill", "skill-one", "SKILL.md"),
                `---
name: skill-one
...
`,
              ...
              Bun.write(
                path.join(dir, ".myassistant", "skill", "skill-two", "SKILL.md"),
                `---
name: skill-two
    ...
    provideTmpdirInstance(
      (dir) =>
        Effect.gen(function* () {
          yield* Effect.promise(() =>
            Bun.write(
              path.join(dir, ".myassistant", "skill", "no-frontmatter", "SKILL.md"),
              `# No Frontmatter
...
`,
              ...
              Bun.write(
                path.join(dir, ".myassistant", "skill", "agent-skill", "SKILL.md"),
                `---
name: myassistant-skill
description: A skill in the .myassistant/skill directory.
---
...
`,
              ...
              Bun.write(
                path.join(dir, ".myassistant", "skills", "agent-skill", "SKILL.md"),
                `---
name: myassistant-skill
description: A skill in the .myassistant/skills directory.
---
