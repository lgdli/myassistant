...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders MYASSISTANT_CALLER", () => {
    process.env["MYASSISTANT_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode MYASSISTANT_CALLER", () => {
    process.env["MYASSISTANT_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown MYASSISTANT_CALLER", () => {
    process.env["MYASSISTANT_CALLER"] = "unknown"
