...
describe("ProxyUtil", () => {
  ...
  describe("headers", () => {
    ...
    test("strips myassistant-specific headers", () => {
      const req = new Request("http://localhost", {
        headers: {
          "x-myassistant-directory": "/home/user/project",
      ...
      const result = ProxyUtil.headers(req)
      expect(result.get("x-myassistant-directory")).toBeNull()
      expect(result.get("x-myassistant-workspace")).toBeNull()
