...
export class Service extends Context.Service<Service, Interface>()("@myassistant/Plugin") {}
  ...
  Effect.gen(function* () {
    ...
    const state = yield* InstanceState.make<State>(
      Effect.fn("Plugin.state")(function* (ctx) {
        ...
        const plugins = Flag.MYASSISTANT_PURE ? [] : (cfg.plugin_origins ?? [])
        if (Flag.MYASSISTANT_PURE && cfg.plugin_origins?.length) {
