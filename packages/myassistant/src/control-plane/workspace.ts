...
export class Service extends Context.Service<Service, Interface>()("@myassistant/Workspace") {}
...
export const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const startSync = Effect.fn("Workspace.startSync")(function* (space: Info) {
      if (!Flag.MYASSISTANT_EXPERIMENTAL_WORKSPACES) return
    ...
    const create = Effect.fn("Workspace.create")(function* (input: CreateInput) {
      ...
      const env = {
        MYASSISTANT_AUTH_CONTENT: JSON.stringify(yield* auth.all()),
        MYASSISTANT_WORKSPACE_ID: config.id,
        MYASSISTANT_EXPERIMENTAL_WORKSPACES: "true",
