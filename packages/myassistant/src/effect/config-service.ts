 ...
 *   "@myassistant/ServerAuthConfig",
 *   {
 *     password: Config.string("MYASSISTANT_SERVER_PASSWORD").pipe(Config.option),
 *     username: Config.string("MYASSISTANT_SERVER_USERNAME").pipe(Config.withDefault("myassistant")),
 *   },
 * ) {}
 *
