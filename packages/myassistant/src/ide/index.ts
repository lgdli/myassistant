...
export function alreadyInstalled() {
  return process.env["MYASSISTANT_CALLER"] === "vscode" || process.env["MYASSISTANT_CALLER"] === "vscode-insiders"
}
...
export async function install(ide: (typeof SUPPORTED_IDES)[number]["name"]) {
  ...
  const p = await Process.run([cmd, "--install-extension", "sst-dev.myassistant"], {
    nothrow: true,
  })
