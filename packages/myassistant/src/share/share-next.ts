import type * as SDK from "@myassistant-ai/sdk/v2"
...
const disabled = process.env["MYASSISTANT_DISABLE_SHARE"] === "true" || process.env["MYASSISTANT_DISABLE_SHARE"] === "1"
...
export class Service extends Context.Service<Service, Interface>()("@myassistant/ShareNext") {}
