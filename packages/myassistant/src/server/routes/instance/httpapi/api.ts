...
export const RootHttpApi = HttpApi.make("myassistant-root").addHttpApi(ControlApi).addHttpApi(GlobalApi)

export const InstanceHttpApi = HttpApi.make("myassistant-instance")
...
export const MyAssistantHttpApi = HttpApi.make("myassistant")
