...
>()("@myassistant/ExperimentalHttpApiWorkspaceRouteContext") {}
...
>()("@myassistant/ExperimentalHttpApiWorkspaceRouting") {}
...
function configuredWorkspaceID(): WorkspaceID | undefined {
  return Flag.MYASSISTANT_WORKSPACE_ID ? WorkspaceID.make(Flag.MYASSISTANT_WORKSPACE_ID) : undefined
}
...
function defaultDirectory(request: HttpServerRequest.HttpServerRequest, url: URL): string {
  return url.searchParams.get("directory") || request.headers["x-myassistant-directory"] || process.cwd()
}
