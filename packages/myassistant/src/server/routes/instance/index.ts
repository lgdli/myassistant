...
export const InstanceRoutes = (upgrade: UpgradeWebSocket, opts?: CorsOptions): Hono => {
  ...
  if (Flag.MYASSISTANT_EXPERIMENTAL_HTTPAPI) {
  ...
  return app
    ...
    .post(
      ...
      describeRoute({
        ...
        description: "Clean up and dispose the current MyAssistant instance, releasing all resources.",
    ...
    .get(
      ...
      describeRoute({
        summary: "Get paths",
        description: "Retrieve the current working directory and related path information for the MyAssistant instance.",
    ...
    .get(
      ...
      describeRoute({
        ...
        description: "Get a list of all available commands in the MyAssistant system.",
    ...
    .get(
      ...
      describeRoute({
        summary: "List agents",
        description: "Get a list of all available AI agents in the MyAssistant system.",
    ...
    .get(
      ...
      describeRoute({
        summary: "List skills",
        description: "Get a list of all available skills in the MyAssistant system.",
