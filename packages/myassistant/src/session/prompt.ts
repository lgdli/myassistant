...
import * as EffectLogger from "@myassistant-ai/core/effect/logger"
...
export class Service extends Context.Service<Service, Interface>()("@myassistant/SessionPrompt") {}
...
export const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const insertReminders = Effect.fn("SessionPrompt.insertReminders")(function* (input: {
      ...
      if (!Flag.MYASSISTANT_EXPERIMENTAL_PLAN_MODE) {
