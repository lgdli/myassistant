...
import myassistant from "./theme/myassistant.json" with { type: "json" }
...
import type { TuiThemeCurrent } from "@myassistant-ai/plugin/tui"
  ...
  init: (props: { mode: "dark" | "light" }) => {
    ...
    setStore(
      produce((draft) => {
        ...
        draft.mode = mode
        draft.lock = lock
        const active = config.theme ?? kv.get("theme", "myassistant")
        draft.active = typeof active === "string" ? active : "myassistant"
        draft.ready = false
      }),
    )
