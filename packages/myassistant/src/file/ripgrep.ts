...
import { sanitizedProcessEnv } from "@myassistant-ai/core/util/myassistant-process"
...
export class Service extends Context.Service<Service, Interface>()("@myassistant/Ripgrep") {}
    ...
    Effect.gen(function* () {
      ...
      const tree: Interface["tree"] = Effect.fn("Ripgrep.tree")(function* (input: TreeInput) {
        ...
        for (const file of list) {
          if (file.includes(".myassistant")) continue
