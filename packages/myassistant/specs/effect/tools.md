...
Practical reference for the current tool-migration state in `packages/myassistant`.
...
Tool tests should use the existing Effect helpers in `packages/myassistant/test/lib/effect.ts`:
