...
Practical reference for new and migrated Effect code in `packages/myassistant`.
...
export class Service extends Context.Service<Service, Interface>()("@myassistant/Foo") {}
