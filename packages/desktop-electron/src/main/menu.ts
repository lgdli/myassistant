...
export function createMenu(deps: Deps) {
  ...
  const template: Electron.MenuItemConstructorOptions[] = [
    ...
    { role: "windowMenu" },
    {
      label: "Help",
      submenu: [
        { label: "MyAssistant Documentation", click: () => shell.openExternal("https://myassistant.ai/docs") },
        { label: "Support Forum", click: () => shell.openExternal("https://discord.com/invite/myassistant") },
        { type: "separator" },
        { type: "separator" },
        {
          label: "Share Feedback",
          click: () =>
            shell.openExternal("https://github.com/anomalyco/myassistant/issues/new?template=feature_request.yml"),
        },
        {
          label: "Report a Bug",
          click: () => shell.openExternal("https://github.com/anomalyco/myassistant/issues/new?template=bug_report.yml"),
        },
      ],
    },
  ]
