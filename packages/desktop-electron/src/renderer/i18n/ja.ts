export const dict = {
  ...
  "desktop.updater.none.message": "すでに最新バージョンの MyAssistant を使用しています",
  ...
  "desktop.updater.downloaded.prompt":
    "MyAssistant のバージョン {{version}} がダウンロードされました。インストールして再起動しますか？",
  ...
  "desktop.cli.installed.message":
    "CLI を {{path}} にインストールしました\n\nターミナルを再起動して 'myassistant' コマンドを使用してください。",
