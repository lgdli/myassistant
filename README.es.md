...
MyAssistant también está disponible como aplicación de escritorio. Descárgala directamente desde la [página de releases](https://github.com/anomalyco/myassistant/releases) o desde [myassistant.ai/download](https://myassistant.ai/download).
...
MyAssistant incluye dos agents integrados que puedes alternar con la tecla `Tab`.
...
Más información sobre [agents](https://myassistant.ai/docs/agents).

### Documentación

Para más información sobre cómo configurar MyAssistant, [**ve a nuestra documentación**](https://myassistant.ai/docs).

### Contribuir

Si te interesa contribuir a MyAssistant, lee nuestras [docs de contribución](./CONTRIBUTING.md) antes de enviar un pull request.
...
- 100% open source
- No está acoplado a ningún proveedor. Aunque recomendamos los modelos que ofrecemos a través de [MyAssistant Zen](https://myassistant.ai/zen); MyAssistant se puede usar con Claude, OpenAI, Google o incluso modelos locales. A medida que evolucionan los modelos, las brechas se cerrarán y los precios bajarán, por lo que ser agnóstico al proveedor es importante.
- Soporte LSP listo para usar
- Un enfoque en la TUI. MyAssistant está construido por usuarios de neovim y los creadores de [terminal.shop](https://terminal.shop); vamos a empujar los límites de lo que es posible en la terminal.
- Arquitectura cliente/servidor. Esto, por ejemplo, permite ejecutar MyAssistant en tu computadora mientras lo controlas de forma remota desde una app móvil. Esto significa que el frontend TUI es solo uno de los posibles clientes.
