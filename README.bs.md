...
<p align="center">MyAssistant je open source AI agent za programiranje.</p>
<p align="center">
...
MyAssistant je dostupan i kao desktop aplikacija. Preuzmi je direktno sa [stranice izdanja](https://github.com/anomalyco/myassistant/releases) ili sa [myassistant.ai/download](https://myassistant.ai/download).
...
MyAssistant uključuje dva ugrađena agenta između kojih možeš prebacivati tasterom `Tab`.
...
Saznaj više o [agentima](https://myassistant.ai/docs/agents).

### Dokumentacija

Za više informacija o konfiguraciji MyAssistant-a, [**pogledaj dokumentaciju**](https://myassistant.ai/docs).

### Doprinosi

Ako želiš doprinositi MyAssistant-u, pročitaj [upute za doprinošenje](./CONTRIBUTING.md) prije slanja pull requesta.
...
- 100% open source
- Nije vezan za jednog provajdera. Iako preporučujemo modele koje nudimo kroz [MyAssistant Zen](https://myassistant.ai/zen), MyAssistant možeš koristiti s Claude, OpenAI, Google ili čak lokalnim modelima. Kako modeli napreduju, razlike među njima će se smanjivati, a cijene padati, zato je nezavisnost od provajdera važna.
- LSP podrška odmah po instalaciji
- Fokus na TUI. MyAssistant grade neovim korisnici i kreatori [terminal.shop](https://terminal.shop); pomjeraćemo granice onoga što je moguće u terminalu.
- Klijent/server arhitektura. To, recimo, omogućava da MyAssistant radi na tvom računaru dok ga daljinski koristiš iz mobilne aplikacije, što znači da je TUI frontend samo jedan od mogućih klijenata.
